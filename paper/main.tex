...
laboratory to list publicly anywhere, under Hong Kong's Chapter~18C listing regime. By 28~August~2026, its shares
had risen about 9-fold to a market capitalisation near US\$62bn---an equity value roughly 312 times its
...
3.0\% of the market price); the price instead embeds a winner-take-all outcome of about US\$71bn revenue
...
model quality, not sector. The gap is capability momentum priced as an option, not a simple bubble.
...
pre-profit issuers. By 28~August~2026, its shares had compounded roughly 9-fold to a market
capitalisation near US\$62bn on FY2026 expected revenue of about US\$200m---an implied equity-value-to-revenue
multiple near 312$\times$ \citep{tushare2026,prospectus2513,prospectus100}. The broader frontier-AI financing wave has
...
then re-rated to HK\$1{,}090 by 28~August~2026 ($\approx +838\%$ versus IPO; realised annualised volatility
near 193\%; Figure~\ref{fig:price}). The post-IPO capital totals 445{,}843{,}090 issued shares
...
Chapter~18C listing, ZCode release, and GLM-5.3-Flash rollout. Each open-weight, cost-disruptive launch is the unit of
...
\begin{table}[H]
\centering
\caption{Three-scenario DCF (USD unless noted; per-share in HKD). Market row at 2026-08-28.}
\label{tab:dcf}
\begin{tabular}{lcccc}
\toprule
...
\midrule
\textit{Market (2026-08-28)} & --- & --- & \textit{US\$62.3B} & \textit{1{,}090} \\
\bottomrule
\end{tabular}
\end{table}
...
We invert the model to ask what justifies the US\$62bn equity value. At WACC~13.5\% and 40\% terminal
margin, the price requires \textbf{about US\$71bn of 2035 revenue}---$\sim$92\% annual growth over
2026--2035. Figure~\ref{fig:revheat} grids WACC (10--20\%) against terminal margin (20--50\%):
even the most favourable cell (10\%/50\%) demands $\sim\$23$bn, and 15\%/40\% pushes to \$98bn. Thus the DCF
...
\caption{Reverse-DCF sensitivity: 2035 revenue (US\$bn) required to justify the US\$62bn equity value
...
\label{sec:rel}
On FY2026E revenue Zhipu trades near \textbf{312$\times$ equity value / revenue}. For context, reported
...
\caption{Equity value / revenue multiples (log scale). Zhipu's $\approx$312$\times$ is roughly an order of magnitude above
...
far to the left of the HK\$1,090 quote, a gap of roughly 9--34$\times$, depending on the valuation anchor.
The market is not pricing a different point on the same distribution; it is pricing a
...
\caption{Rebased prices (IPO~$=100$, log scale, through 2026-08-28). Orange dashed lines mark capability
...
Twenty-six day-level, price-covered, clean-window events enter the CAR panel; excluded entries carry explicit
...
A disciplined valuation cannot reconcile Zhipu's fundamentals (HK\$12--80 per share) with its HK\$1,090
market price (28~August~2026). The reverse DCF shows why: the price embeds a winner-take-all, US\$71bn-revenue
...
\label{sec:revheat}
Table~\ref{tab:revheat} reports the 2035 revenue (US\$bn) required to justify the US\$62bn equity value
across a grid of WACC and terminal-margin assumptions, underlying Figure~\ref{fig:revheat}.

\begin{table}[H]
\centering
\caption{Reverse-DCF sensitivity: required 2035 revenue (US\$bn) to justify US\$62.3bn equity.}
\label{tab:revheat}
...
\cmidrule(lr){2-6}
 & 20\% & 28\% & 35\% & 40\% & 50\% \\
\midrule
10.0\% & 112 & 55 & 38 & 31 & 23 \\
11.5\% & 203 & 85 & 56 & 45 & 33 \\
13.0\% & 411 & 130 & 81 & 64 & 45 \\
\textbf{13.5\%} & \textbf{549} & \textbf{149} & \textbf{91} & \textbf{71} & \textbf{50} \\
15.0\% & $>$1{,}000 & 231 & 129 & 98 & 67 \\
17.0\% & n/a & 452 & 207 & 149 & 96 \\
20.0\% & n/a & $>$1{,}000 & 458 & 285 & 163 \\
\bottomrule
\end{tabular}
