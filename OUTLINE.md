...
**Build:** XeLaTeX (`paper/main.tex` to `main.pdf`). **Data as of 2026-08-31.**
...
- DCF (US$700M FY2026E revenue, -100% initial margin, US$4.289B pro forma net cash, NOL carryforward): bear/base/bull HK$25/73/233; probability-weighted **HK$88 (~7.4% of price)**.
- Reverse DCF: price implies **~US$92B revenue by 2035 (~72% annual, 2026-2035)** after fixing the FY2026E base.
...
- **HKEX interim / annual reports and exchange quotes** - Zhipu, MiniMax, SenseTime, PHANCY, and Wenge AI revenue and 2026-08-31 market-equity inputs; listed references are shown separately from private transactions.
