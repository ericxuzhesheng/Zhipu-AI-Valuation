...
SenseTime, Phancy, and Wenge form a Hong Kong adjacent-AI group; Palantir, Cloudflare, and Snowflake are
commercialisation references \citep{hkcomps2026,softwarecomps2026}. Different economics make both groups
context only. Zhipu is 1.08 times MiniMax but 2.99 times the private median: its listed peer supports much of
the quote, while transactions and DCF still demand caution (Figure~\ref{fig:comps}).
