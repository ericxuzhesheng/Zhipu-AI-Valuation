...
> Word-count audit note: `texcount -inc -sum main.tex` (2026-06-28) gives **2,868 words in text**
> (Sections 1–6 + abstract + appendices). Sections 1–6 body ≈ 2,664 words; with abstract ≈ 2,868.
> Within the 3,000-word ceiling.
