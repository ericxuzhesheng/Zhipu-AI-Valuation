...
come into focus. By 11~September, the stock had fallen 33.6\% from its 31~August close, yet remained
6.8 times its IPO price. Using disclosures through 13~September and prices through 11~September, we combine
scenario DCF, reverse DCF, layered comparables and capability-event analysis. H1 revenue grew 399.7\%,
but operating loss widened to RMB2.15bn. The probability-weighted DCF is HK\$88 against a HK\$793 close;
the reverse DCF requires about US\$60.5bn of 2035 revenue. The original five GLM events show a positive
...
process or convergence to DCF value. Conditional September financing and Wenge's contrasting interim
results help distinguish technical progress from sustainable shareholder returns.
...
Information is restricted to 13~September~2026, with prices through the preceding trading day,
11~September. The original five-event sample remains fixed at 31~August; later observable windows are
...
then experienced a substantial re-rating followed by a reversal to HK\$793 by 11~September~2026 ($\approx +582\%$ versus IPO; realised annualised volatility
...
Zhipu's 33.6\%. The common decline and Zhipu's larger reversal frame the analysis in Section~\ref{sec:event}.
...
expectations about a fat right tail. Roughly 189\% annualised volatility also means that this expectations
...
3.09-fold multiple premium to MiniMax. Thus the observed decline is a partial compression of the
expectations premium, not evidence that the price has already returned to fundamental value. Neither
HK\$88 nor a historical average is an empirically established long-run mean.
...
but it cannot explain that day's return. By 11~September the results window has seven of nine drift days,
so it remains incomplete and outside the original capability sample. The 13~September financing announcement
...
The remaining 226.0x LTM multiple and large DCF gap show that substantial optimism survives. No
...
loss exceeded twice revenue. Against the HK\$793 close, the weighted DCF remains HK\$88, private transactions
imply HK\$240--457, and MiniMax's matched LTM multiple implies HK\$257. The reverse DCF requires about
US\$60.5bn of 2035 revenue. These gaps explain why growth expectations are consequential; they do not
...
The September financing extends the company's prospective capacity to invest but introduces dilution
and a short-maturity debt claim. At the information cutoff it remains conditional and is not added as
settled cash. For valuation, model quality must therefore be translated into revenue, margins, funding
needs and ultimately value per share. The evidence supports a sequence of capability-driven optimism
and subsequent partial mean reversion; it does not prove that the reversal is complete or that the
September financing announcement caused the preceding decline.
