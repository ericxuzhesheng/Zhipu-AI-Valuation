...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/收入倍数-~295x · DCF缺口~97%25-9B51E0?style=for-the-badge" alt="Revenue multiple 354x">
  <img src="https://img.shields.io/badge/License-MIT-blue?style=for-the-badge" alt="MIT">
</p>

> **作者 / Author:** Zhesheng Xu（许哲圣） · **学号 / Student ID:** 42353012 · 公司金融期末项目 / Corporate Finance Final Project
> **核心数据截至 / Core data as of:** 2026-07-29
...
本项目对全球**首家上市的基础大模型公司**——智谱AI（Knowledge Atlas，2513.HK，2026-01-08 经港交所第18C章上市）——做公司金融估值与定价机制研究。核心不是"算出一个目标价"，而是回答一个反直觉的问题：**一家 2025 年收入仅约 1.02 亿美元、2026 年预计收入约 2 亿美元、深度亏损、净权益为负的"早期商业化、尚未盈利"公司，为何上市约六个月暴涨约 10 倍、市值达约 590 亿美元（股权价值/收入约 295 倍）？**

**主结论：** 这既不是单纯的泡沫，也不是有效定价，而是 **"对赢家通吃 AGI 结局的看涨期权 + 能力动量定价"**。基本面 DCF 概率加权约 HK$32/股（约为市价的 2.9%）；现价隐含 2035 年收入约 730 亿美元、2026–2035 年约 93% 的年增速（9 个增长区间）。市场的价格发现已从"盈余惊喜"转向**"能力惊喜"**——围绕模型发布与榜单登顶定价。
...
| **概率加权** | — | — | **$1.9B** | **32** |
| *市价 (2026-07-29)* | — | — | *$59.0B* | *1,033* |

**反向 DCF：** 要支撑现价，需相信 # 能力惊喜，而非盈余惊喜：智谱AI（2513.HK）估值与定价研究 | Capability Surprise, Not Earnings Surprise: Valuing Zhipu AI (2513.HK)
...
**反向 DCF：** 要支撑现价，需相信 2035 年收入约 **US$730 亿**（约 **93%** 的年复合增速，约 365 倍 FY26E）——超级算力巨头级别。市场股权价值/收入约 **295×**，而 OpenAI/Anthropic 一级市场约 30–40×；**MiniMax 是最合适的直接可比对象，中科闻歌因商业模式不同而排除在倍数比较之外**。
...
均值调整口径：`AR_t = R_t - average(R[-20,-6])`。截至 2026-07-29，GLM-5.2 的 [+2,+10] 窗口已覆盖完整 9 个交易日。截图中的其他 Zhipu / MiniMax 模型已进入扩展事件目录，但因缺少估计窗口、日期仅到月份、垂类属性或窗口重叠，不进入主 CAR 表。
...
| 公司 | 代码 | 定位 | 上市表现 |
|---|---|---|---|
| 智谱AI | 2513.HK | 通用基础大模型实验室 | IPO HK$116.20 → HK$1,033（+789%） |
| MiniMax | 00100.HK | 通用/多模态基础模型公司 | IPO HK$165 → ~HK$196（+19%，首日翻倍后大幅回落） |
| 中科闻歌 Wenge AI | 01956.HK | 企业级决策大模型与 AI 解决方案商 | 2026-06-26 上市，IPO HK$60.70 → ~HK$67.8（+12%），市值 ~HK$60 亿 |
...
and volatile cloud-deployment economics — rise ~10x in about six months to a ~US$70.7B market cap
(≈354× equity value / revenue)?**

**Main conclusion:** neither a simple bubble nor efficient pricing, but **a call option on a winner-take-all
AGI outcome, priced through capability momentum**. A disciplined DCF supports only ~HK$32/share (≈2.9% of
price); the price embeds ~US$73B of revenue by 2035 at a ~93% annual rate (2026–2035). Price discovery has shifted from *earnings
...
### Valuation Summary (market row at 2026-07-24)
...
| *Market (2026-07-29)* | — | — | *$59.0B* | *1,033* |

**Reverse DCF:** justifying the price # 能力惊喜，而非盈余惊喜：智谱AI（2513.HK）估值与定价研究 | Capability Surprise, Not Earnings Surprise: Valuing Zhipu AI (2513.HK)
...
**Reverse DCF:** justifying the price requires ~US$73B revenue by 2035 (~93% annual over 2026–2035, ~365×FY26E).
Market equity value / revenue ≈ 295× vs ~30–40× for OpenAI/Anthropic; **MiniMax is the appropriate direct comparable; Wenge AI is
...
——超级算力巨头级别。市场股权价值/收入约 **295×**，而 OpenAI/Anthropic 一级市场约 30–40×；**MiniMax 是最合适的直接可比对象，中科闻歌因商业模式不同而排除在倍数比较之外**。
