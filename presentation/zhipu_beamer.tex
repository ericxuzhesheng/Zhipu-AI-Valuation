  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item 到 2026-07-03，股价从 IPO 价 HK\$116.20 升至 HK\$1,793。
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{为什么传统分析会卡住}
...
\begin{frame}{核心结论不是“泡沫”二字能概括}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.32\textwidth}
      \textbf{预期结论}
      \begin{itemize}
        \item 市价隐含 512x FY2026E revenue。
...
\begin{frame}{股价走势把估值问题推到极端}
  ...
  \vspace{0.2em}
  \footnotesize
  智谱股价较 IPO 约 +1,443\%，而 MiniMax 上市后明显回落。橙色线是能力事件，绿色线是 IPO、指数纳入、Stock Connect、HKEX Tech 100 等资金流或生态事件。
\end{frame}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.38\textwidth}
      ...
      \begin{itemize}
        ...
        \item 即使把这些变量调得更乐观，也难以靠普通 DCF 接近 HK\$1,793。
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.38\textwidth}
      ...
      \begin{itemize}
        ...
        \item 在 WACC 13.5\%、终值增长 4\% 下，隐含 2035 年收入约 US\$118bn。
      \end{itemize}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item MiniMax 的对应能力事件反应弱，后续漂移为负。
